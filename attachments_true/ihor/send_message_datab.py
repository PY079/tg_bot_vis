...
# da = os.path.join(home_dir, 'bots/tg_bot_vis/attachments_true/users.db')
# pk = 'C:/Users/User/Desktop/tg_bot_mus/post_tg/1/attachments_true/users.db'
s = '/root/bots/tg_bot_vis/attachments_true/ihor/users.db'
