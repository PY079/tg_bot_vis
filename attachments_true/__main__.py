...
4. /attach_a_message позволяет отправить историю или сообщение с вложением. \nВ первый раз отправьте одно вложение с текстом (или без). После этого можно добавить еще вложения без текста до максимума в 10 штук.
Обратите внимание, что текст, который вы если напишете в каждое вложение, то он будет прикреплен ко всем вложениям, а не как подпись к сообщению.
Когда закончите добавлять вложения, нажмите кнопку "Отправить".\n
...
Мы желаем вам удачного пользования и приятного полета.''')
            ...
            elif error_code == 400 and 'document can\'t be mixed with other media types':
