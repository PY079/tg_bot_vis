...
4. /attach_a_message позволяет отправить историю или сообщение с вложением. В первый раз отправьте одно вложение с текстом (или без). После этого можно добавить еще вложения без текста до максимума в 10 штук.
...
Когда закончите добавлять вложения, нажми кнопку "Отправить".\n
